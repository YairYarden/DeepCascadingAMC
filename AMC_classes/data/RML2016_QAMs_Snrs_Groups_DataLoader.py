...
class RML2016_QAMs_SNR_groups_DataLoader(object):
    def __init__(
...
def load_RML201610B_onlyQAMs_dividedBySNR(path: str = None) -> Dataset:
    ...
    loader = RML2016_QAMs_SNR_groups_DataLoader(
